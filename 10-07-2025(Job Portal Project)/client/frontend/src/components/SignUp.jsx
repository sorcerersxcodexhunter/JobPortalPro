  ...
  const handelSubmit = async(e) => {
    ...
    try {
      ...
      if (responce.data.success) {
        ...
        // Show profile picture saved notification if profilePicture was uploaded and backend returned a profilePic URL
        if (profilePicture && responce.data.profilePic) {
